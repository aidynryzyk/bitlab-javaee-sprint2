...
public class ItemDAO {
    ...
    private static final String CREATE_ITEM_SQL = "INSERT INTO items (name, description, price, sold, category_id) VALUES (?, ?, ?, ?, ?)";
    ...
    private static final String UPDATE_ITEM_SQL = "UPDATE items SET name = ?, description = ?, price = ?, sold = ?, category_id = ? WHERE id = ?";
    ...
    private List<Item> getAll(boolean sortBySoldDesc, boolean selectByCategory, long categoryId) {
        try (Connection connection = DBConnector.getConnection()) {
